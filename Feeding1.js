        ...
        <div>
            <table className="fT1" cellSpacing="25px">
                <tr>
                    ...
                    <td><h1 className="topic1">Formula Feeding: </h1><br /><br />
                    ...
                    <td><h1 className="topic1">Responsive Feeding:</h1> <br /><br />
